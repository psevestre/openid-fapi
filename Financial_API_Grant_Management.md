...
# Appendix A
## Grant Management for Open Banking use cases
### Client requesting authorisation 
### Client inspecting existing authorisation
### Client updating authorisation
### Client deleting authorisation
## Grant Managemment for multi-party approval use cases

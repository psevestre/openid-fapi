...
1. For the `authorization_endpoint`, the authorization server MAY allow additional cipher suites other than those permitted by the latest version of [BCP195], if necessary to support users' web browsers when the risk was determined to be permissible.
